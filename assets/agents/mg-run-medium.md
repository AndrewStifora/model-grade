---
name: mg-run-medium
description: Executor for the /model-grade skill only. Runs a prompt that model-grade routed here at medium effort on the model the caller passed in. Do not pick this agent for ordinary delegation; use general-purpose instead.
model: inherit
effort: medium
---
